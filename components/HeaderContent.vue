  ...
  <div>
    ...
    <div class="usernav">
     ...
     <div class="welcome" id="divMemberPanel">
      ...
      <div id="logo">
        <p style="text-align: left;"><a href=""><img src="https://www.minikterzi.com/Uploads/EditorUploads/Logo/MinikTerziLogo.png" ></a></p>
      </div>
...
.mycart > a span.sepetTecxt::after{
  clear:both;
  display: table;
  content: " ";
}
